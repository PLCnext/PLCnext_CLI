...
{
    [Verb(CommandLineConstants.IncludepathsVerb, HelpText = "Lists all include paths which are relevant for this project.")]
    ...
    internal class GetIncludePathsVerb : GetVerb
    {
        ...
        {
            return await commandManager.Execute(new GetIncludePathsCommandArgs(Path));
        }
    }
}
