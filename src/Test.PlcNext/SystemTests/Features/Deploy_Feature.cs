    ...
    public class Deploy_Feature : MockedSystemTestBase
    {
        ...
        public async Task Deploy_for_project_with_external_libraries_via_cmake_generates_library()
        {
            await Runner.AddSteps(
                _ => Given_is_the_project("Demo"),
                _ => Given_is_the_working_directory_PATH("Demo"),
                _ => Given_is_that_the_cmake_build_system_exists_for_targets("AXCF2152_19.0.0.12345"),
                _ => Given_is_that_the_cmake_build_system_exists_for_targets("AXCF2152_20.6.0.12345"),
                _ => Given_is_that_the_directory_exists("sysroots"),
                _ => Given_is_that_the_file_exists("intermediate/cmake/AXCF2152_19.0.0.12345/Debug/Some/Path/T,o/Some.so"),
                _ => Given_is_that_the_file_exists("intermediate/cmake/AXCF2152_20.6.0.12345/Debug/Some/Path/T,o/Some.so"),
        ...
        public async Task Deploy_for_project_with_external_libraries_via_cmake_with_excluded_library_generates_library()
        {
            await Runner.AddSteps(
                ...
                _ => Given_is_that_the_cmake_build_system_exists_for_targets("ACXF2152_20.6.0.12345"),
                _ => Given_is_that_the_directory_exists("sysroots"),
                _ => Given_is_that_the_file_exists("intermediate/cmake/AXCF2152_20.6.0.12345/Release/My/Cust,om/Lib/rary.so"),
                _ => Given_is_that_the_file_exists("intermediate/cmake/AXCF2152_20.6.0.12345/Release/My/Other/Library.so"),
                _ => Given_is_that_the_file_exists("intermediate/cmake/AXCF2152_20.6.0.12345/Release/Some/Path/T,o/Some.so"),
