    ...
    public class Generate_Library_Feature : MockedSystemTestBase
    {
        ...
        public async Task Generate_library_executed_with_multibinary()
        {
            await Runner.AddSteps(
                ...
                _ => Given_is_that_the_cmake_build_system_exists_for_targets_and_type("Release", "AXCF2152,100.0.0.12345", "AXCF2152,200.0.0.12345"),
                _ => Given_is_that_the_directory_exists("sysroots"),
                _ => Given_cmake_returns_a_code_model_with_the_following_libraries("Demo"),
                _ => When_I_generate_the_library(new LibraryCommandArgs {Targets = new[] { "axcf2152,100.0", "axcf2152,200"} }),
        ...
        public async Task Generate_library_executed_with_external_libraries_via_cmake()
        {
            await Runner.AddSteps(
                ...
                _ => Given_is_the_working_directory_PATH("Demo"),
                _ => Given_is_that_the_cmake_build_system_exists_for_targets_and_type("Release", "AXCF2152,19.0.0.12345"),
                _ => Given_is_that_the_cmake_build_system_exists_for_targets_and_type("Release", "AXCF2152,20.6.0.12345"),
                _ => Given_is_that_the_directory_exists("sysroots"),
