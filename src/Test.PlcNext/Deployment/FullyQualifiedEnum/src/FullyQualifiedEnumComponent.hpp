...
#include "FullyQualifiedEnumComponentProgramProvider.hpp"
...
//#component
class FullyQualifiedEnumComponent : public ComponentBase, public ProgramComponentBase, private Loggable<FullyQualifiedEnumComponent>
{
public: // typedefs

public: // construction/destruction
    FullyQualifiedEnumComponent(IApplication& application, const String& name);
    virtual ~FullyQualifiedEnumComponent() = default;
...
private: // methods
    FullyQualifiedEnumComponent(const FullyQualifiedEnumComponent& arg) = delete;
    FullyQualifiedEnumComponent& operator= (const FullyQualifiedEnumComponent& arg) = delete;

public: // static factory operations
    static IComponent::Ptr Create(Arp::System::Acf::IApplication& application, const String& name);

private: // fields
    FullyQualifiedEnumComponentProgramProvider programProvider;
...
inline IComponent::Ptr FullyQualifiedEnumComponent::Create(Arp::System::Acf::IApplication& application, const String& name)
{
    return IComponent::Ptr(new FullyQualifiedEnumComponent(application, name));
}
