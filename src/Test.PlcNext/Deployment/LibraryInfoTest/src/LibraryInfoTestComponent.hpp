...
#include "LibraryInfoTestComponentProgramProvider.hpp"
...
//#component
class LibraryInfoTestComponent : public ComponentBase, public ProgramComponentBase, private Loggable<LibraryInfoTestComponent>
{
public: // typedefs

public: // construction/destruction
#if ARP_ABI_VERSION_MAJOR < 2
    LibraryInfoTestComponent(IApplication& application, const String& name);
    virtual ~LibraryInfoTestComponent() = default;
#else
    LibraryInfoTestComponent(ILibrary& library, const String& name);
#endif
...
private: // methods
#if ARP_ABI_VERSION_MAJOR < 2
    LibraryInfoTestComponent(const LibraryInfoTestComponent& arg) = delete;
    LibraryInfoTestComponent& operator= (const LibraryInfoTestComponent& arg) = delete;
...
private: // fields
    LibraryInfoTestComponentProgramProvider programProvider;
...
#if ARP_ABI_VERSION_MAJOR < 2
inline IComponent::Ptr LibraryInfoTestComponent::Create(Arp::System::Acf::IApplication& application, const String& name)
{
    return IComponent::Ptr(new LibraryInfoTestComponent(application, name));
}
#endif
