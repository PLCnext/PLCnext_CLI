...
#include "InheritanceStructsComponentProgramProvider.hpp"
...
//#component
class InheritanceStructsComponent : public ComponentBase, public ProgramComponentBase, private Loggable<InheritanceStructsComponent>
{
public: // typedefs

public: // construction/destruction
    InheritanceStructsComponent(IApplication& application, const String& name);
    virtual ~InheritanceStructsComponent() = default;
...
private: // methods
    InheritanceStructsComponent(const InheritanceStructsComponent& arg) = delete;
    InheritanceStructsComponent& operator= (const InheritanceStructsComponent& arg) = delete;

public: // static factory operations
    static IComponent::Ptr Create(Arp::System::Acf::IApplication& application, const String& name);

private: // fields
    InheritanceStructsComponentProgramProvider programProvider;
...
inline IComponent::Ptr InheritanceStructsComponent::Create(Arp::System::Acf::IApplication& application, const String& name)
{
    return IComponent::Ptr(new InheritanceStructsComponent(application, name));
}
