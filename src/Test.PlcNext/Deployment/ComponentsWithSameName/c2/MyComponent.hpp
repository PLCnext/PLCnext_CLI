...
#include "Test\MyComponentProgramProvider.hpp"
#include "Test\TestLibrary.hpp"
...
namespace ComponentsWithSameName { namespace c2 {
...
: ComponentBase(application, ::Test::TestLibrary::GetInstance(), name, ComponentCategory::Custom)
, dataInfoProvider(::Test::TestLibrary::GetInstance().GetNamespace(), &(this->programProvider))
{
}
...
}} // end of namespace ComponentsWithSameName::c2
