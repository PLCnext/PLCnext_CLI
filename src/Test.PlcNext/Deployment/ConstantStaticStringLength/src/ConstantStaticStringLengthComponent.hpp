...
#include "ConstantStaticStringLengthComponentProgramProvider.hpp"
...
//#component
class ConstantStaticStringLengthComponent : public ComponentBase, public ProgramComponentBase, private Loggable<ConstantStaticStringLengthComponent>
{
public: // typedefs

public: // construction/destruction
    ConstantStaticStringLengthComponent(IApplication& application, const String& name);
    virtual ~ConstantStaticStringLengthComponent() = default;
...
private: // methods
    ConstantStaticStringLengthComponent(const ConstantStaticStringLengthComponent& arg) = delete;
    ConstantStaticStringLengthComponent& operator= (const ConstantStaticStringLengthComponent& arg) = delete;

public: // static factory operations
    static IComponent::Ptr Create(Arp::System::Acf::IApplication& application, const String& name);

private: // fields
    ConstantStaticStringLengthComponentProgramProvider programProvider;
...
inline IComponent::Ptr ConstantStaticStringLengthComponent::Create(Arp::System::Acf::IApplication& application, const String& name)
{
    return IComponent::Ptr(new ConstantStaticStringLengthComponent(application, name));
}
