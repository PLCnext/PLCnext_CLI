...
#include "TemplatedStructComponentProgramProvider.hpp"
...
//#component
class TemplatedStructComponent : public ComponentBase, public ProgramComponentBase, private Loggable<TemplatedStructComponent>
{
public: // typedefs

public: // construction/destruction
    TemplatedStructComponent(IApplication& application, const String& name);
    virtual ~TemplatedStructComponent() = default;
...
private: // methods
    TemplatedStructComponent(const TemplatedStructComponent& arg) = delete;
    TemplatedStructComponent& operator= (const TemplatedStructComponent& arg) = delete;

public: // static factory operations
    static IComponent::Ptr Create(Arp::System::Acf::IApplication& application, const String& name);

private: // fields
    TemplatedStructComponentProgramProvider programProvider;
...
inline IComponent::Ptr TemplatedStructComponent::Create(Arp::System::Acf::IApplication& application, const String& name)
{
    return IComponent::Ptr(new TemplatedStructComponent(application, name));
}
