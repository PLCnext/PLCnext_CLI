...
#include "PortTypesInDifNamespacesComponentProgramProvider.hpp"
...
//#component
class PortTypesInDifNamespacesComponent : public ComponentBase, public ProgramComponentBase, private Loggable<PortTypesInDifNamespacesComponent>
{
public: // typedefs

public: // construction/destruction
    PortTypesInDifNamespacesComponent(IApplication& application, const String& name);
    virtual ~PortTypesInDifNamespacesComponent() = default;
...
private: // methods
    PortTypesInDifNamespacesComponent(const PortTypesInDifNamespacesComponent& arg) = delete;
    PortTypesInDifNamespacesComponent& operator= (const PortTypesInDifNamespacesComponent& arg) = delete;

public: // static factory operations
    static IComponent::Ptr Create(Arp::System::Acf::IApplication& application, const String& name);

private: // fields
    PortTypesInDifNamespacesComponentProgramProvider programProvider;
...
inline IComponent::Ptr PortTypesInDifNamespacesComponent::Create(Arp::System::Acf::IApplication& application, const String& name)
{
    return IComponent::Ptr(new PortTypesInDifNamespacesComponent(application, name));
}
