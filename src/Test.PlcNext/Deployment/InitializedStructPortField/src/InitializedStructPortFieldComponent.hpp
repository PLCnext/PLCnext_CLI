...
#include "InitializedStructPortFieldComponentProgramProvider.hpp"
...
//#component
class InitializedStructPortFieldComponent : public ComponentBase, public ProgramComponentBase, private Loggable<InitializedStructPortFieldComponent>
{
public: // typedefs

public: // construction/destruction
    InitializedStructPortFieldComponent(IApplication& application, const String& name);
    virtual ~InitializedStructPortFieldComponent() = default;
...
private: // methods
    InitializedStructPortFieldComponent(const InitializedStructPortFieldComponent& arg) = delete;
    InitializedStructPortFieldComponent& operator= (const InitializedStructPortFieldComponent& arg) = delete;

public: // static factory operations
    static IComponent::Ptr Create(Arp::System::Acf::IApplication& application, const String& name);

private: // fields
    InitializedStructPortFieldComponentProgramProvider programProvider;
...
inline IComponent::Ptr InitializedStructPortFieldComponent::Create(Arp::System::Acf::IApplication& application, const String& name)
{
    return IComponent::Ptr(new InitializedStructPortFieldComponent(application, name));
}
