...
inline IComponent::Ptr MyComponentImpl::Create(IApplication& application, const String& componentName)
{
    return IComponent::Ptr(new MyComponentImpl(application, componentName));
}
