...
#include "ProjectWithRedundancyAttributeComponentProgramProvider.hpp"
...
//#component
class ProjectWithRedundancyAttributeComponent : public ComponentBase, public ProgramComponentBase, private Loggable<ProjectWithRedundancyAttributeComponent>
{
public: // typedefs

public: // construction/destruction
    ProjectWithRedundancyAttributeComponent(IApplication& application, const String& name);
    virtual ~ProjectWithRedundancyAttributeComponent() = default;
...
private: // methods
    ProjectWithRedundancyAttributeComponent(const ProjectWithRedundancyAttributeComponent& arg) = delete;
    ProjectWithRedundancyAttributeComponent& operator= (const ProjectWithRedundancyAttributeComponent& arg) = delete;

public: // static factory operations
    static IComponent::Ptr Create(Arp::System::Acf::IApplication& application, const String& name);

private: // fields
    ProjectWithRedundancyAttributeComponentProgramProvider programProvider;
...
inline IComponent::Ptr ProjectWithRedundancyAttributeComponent::Create(Arp::System::Acf::IApplication& application, const String& name)
{
    return IComponent::Ptr(new ProjectWithRedundancyAttributeComponent(application, name));
}
