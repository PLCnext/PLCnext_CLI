...
#include "CppSpecialComponentProgramProvider.hpp"
...
//#component
class CppSpecialComponent : public ComponentBase, public ProgramComponentBase, private Loggable<CppSpecialComponent>
{
public: // typedefs

public: // construction/destruction
    CppSpecialComponent(IApplication& application, const String& name);
    virtual ~CppSpecialComponent() = default;
...
private: // methods
    CppSpecialComponent(const CppSpecialComponent& arg) = delete;
    CppSpecialComponent& operator= (const CppSpecialComponent& arg) = delete;

public: // static factory operations
    static IComponent::Ptr Create(Arp::System::Acf::IApplication& application, const String& name);

private: // fields
    CppSpecialComponentProgramProvider programProvider;
...
inline IComponent::Ptr CppSpecialComponent::Create(Arp::System::Acf::IApplication& application, const String& name)
{
    return IComponent::Ptr(new CppSpecialComponent(application, name));
}
