...
#include "PpDirectivesComponentProgramProvider.hpp"
...
//#component
class PpDirectivesComponent : public ComponentBase, public ProgramComponentBase, private Loggable<PpDirectivesComponent>
{
public: // typedefs

public: // construction/destruction
    PpDirectivesComponent(IApplication& application, const String& name);
    virtual ~PpDirectivesComponent() = default;
...
private: // methods
    PpDirectivesComponent(const PpDirectivesComponent& arg) = delete;
    PpDirectivesComponent& operator= (const PpDirectivesComponent& arg) = delete;

public: // static factory operations
    static IComponent::Ptr Create(Arp::System::Acf::IApplication& application, const String& name);

private: // fields
    PpDirectivesComponentProgramProvider programProvider;
...
inline IComponent::Ptr PpDirectivesComponent::Create(Arp::System::Acf::IApplication& application, const String& name)
{
#define COMPONENT_VALUE 13
    return IComponent::Ptr(new PpDirectivesComponent(application, name));
}
