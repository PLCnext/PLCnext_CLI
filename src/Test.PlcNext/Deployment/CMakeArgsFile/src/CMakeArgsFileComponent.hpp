...
#include "CMakeArgsFileComponentProgramProvider.hpp"
...
//#component
class CMakeArgsFileComponent : public ComponentBase, public ProgramComponentBase, private Loggable<CMakeArgsFileComponent>
{
public: // typedefs

public: // construction/destruction
    CMakeArgsFileComponent(IApplication& application, const String& name);
    virtual ~CMakeArgsFileComponent() = default;
...
private: // methods
    CMakeArgsFileComponent(const CMakeArgsFileComponent& arg) = delete;
    CMakeArgsFileComponent& operator= (const CMakeArgsFileComponent& arg) = delete;

public: // static factory operations
    static IComponent::Ptr Create(Arp::System::Acf::IApplication& application, const String& name);

private: // fields
    CMakeArgsFileComponentProgramProvider programProvider;
...
inline IComponent::Ptr CMakeArgsFileComponent::Create(Arp::System::Acf::IApplication& application, const String& name)
{
    return IComponent::Ptr(new CMakeArgsFileComponent(application, name));
}
