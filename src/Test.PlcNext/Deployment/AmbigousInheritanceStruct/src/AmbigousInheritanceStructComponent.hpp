...
#include "AmbigousInheritanceStructComponentProgramProvider.hpp"
...
//#component
class AmbigousInheritanceStructComponent : public ComponentBase, public ProgramComponentBase, private Loggable<AmbigousInheritanceStructComponent>
{
public: // typedefs

public: // construction/destruction
    AmbigousInheritanceStructComponent(IApplication& application, const String& name);
    virtual ~AmbigousInheritanceStructComponent() = default;
...
private: // methods
    AmbigousInheritanceStructComponent(const AmbigousInheritanceStructComponent& arg) = delete;
    AmbigousInheritanceStructComponent& operator= (const AmbigousInheritanceStructComponent& arg) = delete;

public: // static factory operations
    static IComponent::Ptr Create(Arp::System::Acf::IApplication& application, const String& name);

private: // fields
    AmbigousInheritanceStructComponentProgramProvider programProvider;
...
inline IComponent::Ptr AmbigousInheritanceStructComponent::Create(Arp::System::Acf::IApplication& application, const String& name)
{
    return IComponent::Ptr(new AmbigousInheritanceStructComponent(application, name));
}
