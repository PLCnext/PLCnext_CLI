...
#include "OtherNamespaceConstantComponentProgramProvider.hpp"
...
//#component
class OtherNamespaceConstantComponent : public ComponentBase, public ProgramComponentBase, private Loggable<OtherNamespaceConstantComponent>
{
public: // typedefs

public: // construction/destruction
    OtherNamespaceConstantComponent(IApplication& application, const String& name);
    virtual ~OtherNamespaceConstantComponent() = default;
...
private: // methods
    OtherNamespaceConstantComponent(const OtherNamespaceConstantComponent& arg) = delete;
    OtherNamespaceConstantComponent& operator= (const OtherNamespaceConstantComponent& arg) = delete;

public: // static factory operations
    static IComponent::Ptr Create(Arp::System::Acf::IApplication& application, const String& name);

private: // fields
    OtherNamespaceConstantComponentProgramProvider programProvider;
...
inline IComponent::Ptr OtherNamespaceConstantComponent::Create(Arp::System::Acf::IApplication& application, const String& name)
{
    return IComponent::Ptr(new OtherNamespaceConstantComponent(application, name));
}
