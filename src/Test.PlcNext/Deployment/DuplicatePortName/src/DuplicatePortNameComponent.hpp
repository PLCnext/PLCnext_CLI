...
#include "DuplicatePortNameComponentProgramProvider.hpp"
...
//#component
class DuplicatePortNameComponent : public ComponentBase, public ProgramComponentBase, private Loggable<DuplicatePortNameComponent>
{
public: // typedefs

public: // construction/destruction
    DuplicatePortNameComponent(IApplication& application, const String& name);
    virtual ~DuplicatePortNameComponent() = default;
...
private: // methods
    DuplicatePortNameComponent(const DuplicatePortNameComponent& arg) = delete;
    DuplicatePortNameComponent& operator= (const DuplicatePortNameComponent& arg) = delete;

public: // static factory operations
    static IComponent::Ptr Create(Arp::System::Acf::IApplication& application, const String& name);

private: // fields
    DuplicatePortNameComponentProgramProvider programProvider;
...
inline IComponent::Ptr DuplicatePortNameComponent::Create(Arp::System::Acf::IApplication& application, const String& name)
{
    return IComponent::Ptr(new DuplicatePortNameComponent(application, name));
}
