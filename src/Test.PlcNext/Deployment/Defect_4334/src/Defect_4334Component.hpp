...
#include "Defect_4334ComponentProgramProvider.hpp"
...
//#component
class Defect_4334Component : public ComponentBase, public ProgramComponentBase, private Loggable<Defect_4334Component>
{
public: // typedefs

public: // construction/destruction
    Defect_4334Component(IApplication& application, const String& name);
    virtual ~Defect_4334Component() = default;
...
private: // methods
    Defect_4334Component(const Defect_4334Component& arg) = delete;
    Defect_4334Component& operator= (const Defect_4334Component& arg) = delete;

public: // static factory operations
    static IComponent::Ptr Create(Arp::System::Acf::IApplication& application, const String& name);

private: // fields
    Defect_4334ComponentProgramProvider programProvider;
...
inline IComponent::Ptr Defect_4334Component::Create(Arp::System::Acf::IApplication& application, const String& name)
{
    return IComponent::Ptr(new Defect_4334Component(application, name));
}
