...
#include "ProjectWithRedundancyAndWrongTargetComponentProgramProvider.hpp"
...
//#component
class ProjectWithRedundancyAndWrongTargetComponent : public ComponentBase, public ProgramComponentBase, private Loggable<ProjectWithRedundancyAndWrongTargetComponent>
{
public: // typedefs

public: // construction/destruction
    ProjectWithRedundancyAndWrongTargetComponent(IApplication& application, const String& name);
    virtual ~ProjectWithRedundancyAndWrongTargetComponent() = default;
...
private: // methods
    ProjectWithRedundancyAndWrongTargetComponent(const ProjectWithRedundancyAndWrongTargetComponent& arg) = delete;
    ProjectWithRedundancyAndWrongTargetComponent& operator= (const ProjectWithRedundancyAndWrongTargetComponent& arg) = delete;

public: // static factory operations
    static IComponent::Ptr Create(Arp::System::Acf::IApplication& application, const String& name);

private: // fields
    ProjectWithRedundancyAndWrongTargetComponentProgramProvider programProvider;
...
inline IComponent::Ptr ProjectWithRedundancyAndWrongTargetComponent::Create(Arp::System::Acf::IApplication& application, const String& name)
{
    return IComponent::Ptr(new ProjectWithRedundancyAndWrongTargetComponent(application, name));
}
