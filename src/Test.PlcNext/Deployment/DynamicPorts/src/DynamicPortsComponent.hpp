...
#include "DynamicPortsComponentProgramProvider.hpp"
...
//#component
class DynamicPortsComponent : public ComponentBase, public ProgramComponentBase, private Loggable<DynamicPortsComponent>
{
public: // typedefs

public: // construction/destruction
    DynamicPortsComponent(IApplication& application, const String& name);
    virtual ~DynamicPortsComponent() = default;
...
private: // methods
    DynamicPortsComponent(const DynamicPortsComponent& arg) = delete;
    DynamicPortsComponent& operator= (const DynamicPortsComponent& arg) = delete;

public: // static factory operations
    static IComponent::Ptr Create(Arp::System::Acf::IApplication& application, const String& name);

private: // fields
    DynamicPortsComponentProgramProvider programProvider;
...
inline IComponent::Ptr DynamicPortsComponent::Create(Arp::System::Acf::IApplication& application, const String& name)
{
    return IComponent::Ptr(new DynamicPortsComponent(application, name));
}
