...
//#acfcomponent
class AcfProjectv216withoutprojComponent : public ComponentBase, public MetaComponentBase, private Loggable<AcfProjectv216withoutprojComponent>
{
public: // typedefs

public: // construction/destruction
    AcfProjectv216withoutprojComponent(IApplication& application, const String& name);
    virtual ~AcfProjectv216withoutprojComponent() = default;
...
private: // methods
    AcfProjectv216withoutprojComponent(const AcfProjectv216withoutprojComponent& arg) = delete;
    AcfProjectv216withoutprojComponent& operator= (const AcfProjectv216withoutprojComponent& arg) = delete;
...
inline IComponent::Ptr AcfProjectv216withoutprojComponent::Create(Arp::System::Acf::IApplication& application, const String& name)
{
    return IComponent::Ptr(new AcfProjectv216withoutprojComponent(application, name));
}
