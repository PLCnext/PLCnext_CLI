...
#include "ProgramWithSameProgramNamesComponentProgramProvider.hpp"
...
//#component
class ProgramWithSameProgramNamesComponent : public ComponentBase, public ProgramComponentBase, private Loggable<ProgramWithSameProgramNamesComponent>
{
public: // typedefs

public: // construction/destruction
    ProgramWithSameProgramNamesComponent(IApplication& application, const String& name);
    virtual ~ProgramWithSameProgramNamesComponent() = default;
...
private: // methods
    ProgramWithSameProgramNamesComponent(const ProgramWithSameProgramNamesComponent& arg) = delete;
    ProgramWithSameProgramNamesComponent& operator= (const ProgramWithSameProgramNamesComponent& arg) = delete;

public: // static factory operations
    static IComponent::Ptr Create(Arp::System::Acf::IApplication& application, const String& name);

private: // fields
    ProgramWithSameProgramNamesComponentProgramProvider programProvider;
...
inline IComponent::Ptr ProgramWithSameProgramNamesComponent::Create(Arp::System::Acf::IApplication& application, const String& name)
{
    return IComponent::Ptr(new ProgramWithSameProgramNamesComponent(application, name));
}
