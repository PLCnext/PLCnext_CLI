...
#include "ArrayDatatypesComponentProgramProvider.hpp"
...
//#component
class ArrayDatatypesComponent : public ComponentBase, public ProgramComponentBase, private Loggable<ArrayDatatypesComponent>
{
public: // typedefs

public: // construction/destruction
    ArrayDatatypesComponent(IApplication& application, const String& name);
    virtual ~ArrayDatatypesComponent() = default;
...
private: // methods
    ArrayDatatypesComponent(const ArrayDatatypesComponent& arg) = delete;
    ArrayDatatypesComponent& operator= (const ArrayDatatypesComponent& arg) = delete;

public: // static factory operations
    static IComponent::Ptr Create(Arp::System::Acf::IApplication& application, const String& name);

private: // fields
    ArrayDatatypesComponentProgramProvider programProvider;
...
inline IComponent::Ptr ArrayDatatypesComponent::Create(Arp::System::Acf::IApplication& application, const String& name)
{
    return IComponent::Ptr(new ArrayDatatypesComponent(application, name));
}
