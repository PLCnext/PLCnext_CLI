...
namespace PlcNext.Common {
    ...
    internal class ExceptionTexts {
        ...
        /// <summary>
        ///   Looks up a localized string similar to A file with name {0} was added more than once to the library. This is not allowed..
        /// </summary>
        internal static string DuplicateFileDeployed {
            get {
                return ResourceManager.GetString("DuplicateFileDeployed", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to The project was created with a higher version ({0}) of PLCnCli than the current ({1}) and can not be processed. Please update the PLCnCli toolchain.
        /// </summary>
        internal static string ProjectVersionMismatch {
            get {
                return ResourceManager.GetString("ProjectVersionMismatch", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to The SDK destination path &apos;{0}&apos; should not contain spaces..
        /// </summary>
        internal static string SdkPathWithSpaces {
            get {
                return ResourceManager.GetString("SdkPathWithSpaces", resourceCulture);
            }
        }
