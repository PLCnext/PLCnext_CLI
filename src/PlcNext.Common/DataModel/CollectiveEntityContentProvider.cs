...
{
    internal class CollectiveEntityContentProvider : IEntityContentProvider
    {
        ...
        public CollectiveEntityContentProvider(IEnumerable<IEntityContentProvider> contentResolvers)
        {
